...
- Detect assertion misuse patterns that reduce clarity or performance.
- Suggest fluent API improvements (including safe `.And` usage patterns).
- Offer code fixes where practical.
